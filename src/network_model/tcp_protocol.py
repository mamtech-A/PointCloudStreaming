...
class TCPConnection:
    ...
    def __init__(self, src='src', dst='dst', rtt_ms=50, rtt_jitter_ms=0, loss_prob=0.0, cwnd_packets=10, mss_bytes=1460, rto_formula='jacobson', rto_fixed_s=1.0, log_packets=True):
        self.src = src
        self.dst = dst
        # When False, skip building/appending per-packet log entries (big speedup
        # for RL training, which never reads them). Timing/behavior are unchanged.
